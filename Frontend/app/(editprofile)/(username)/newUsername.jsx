...
const ChangeUsernameScreen = ({ route, navigation }) => {
  ...
  const handleChangeUsername = async () => {
    ...
    try {
      const response = await axios.put('http://192.168.210.178:8080/api/v1/users/update-username', requestBody);
...
const styles = StyleSheet.create({
  container: { flex: 1, justifyContent: 'center', paddingHorizontal: 20, backgroundColor: '#1d6b6b', height:630 },
